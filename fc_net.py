     ...
     # #  print(X.shape)
      #  print(self.params['W1'].shape)
       # print(self.params['W2'].shape)
        dout_1, cache1 = affine_relu_forward(X, self.params['W1'],self.params['b1'])
        scores, cache2 = affine_forward(dout_1, self.params['W2'],self.params['b2'])
        ...
        dx1, dw1, db1 = affine_backward (dscores,cache2)
#        dscores1 = np.dot(affine2_x,affine2_w)+ affine2_b
        dx, dw, db = affine_relu_backward (dx1,cache1)       
